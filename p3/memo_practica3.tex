...
Para hallar esto nos debemos de fijar en el bucle que comienza en la línea 113 y analizarlo. Nos damos cuenta que el algoritmo revisa todas las ciudades para quedarse con la que aumenta el recorrido total en menor medida. Y eso lo realiza con cada ciudad nueva que se añade al bucle.
